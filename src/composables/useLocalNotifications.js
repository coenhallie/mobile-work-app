...
/**
 * Composable for managing local notifications
 *
 * This composable provides a clean interface to the local notification
...
export function useLocalNotifications() {
  ...
  const initializeNotifications = async () => {
    ...
    try {
      ...
      const result = await localNotificationService.initialize();
  ...
  const sendTestNotification = async () => {
    ...
    try {
      ...
      const success = await sendNotification({
        ...
        body: 'This is a test local notification from your mobile work app.',
